...
const mockTourPlaces: TourPlaceResponseDto[] = [
  { tourPlaceId: 1, category: '맛집', address: '도톤보리', rating: 4.6, placeName: '이치란 라멘', description: '오사카에서 즐기는 대표 라멘' },
  { tourPlaceId: 2, category: '맛집', address: '신세카이', rating: 4.4, placeName: '쿠시카츠 다루마', description: '바삭한 쿠시카츠 전문점' },
  { tourPlaceId: 3, category: '맛집', address: '난바', rating: 4.7, placeName: '하리주 그릴', description: '오래된 오사카식 그릴' },
  { tourPlaceId: 4, category: '맛집', address: '도톤보리', rating: 4.5, placeName: '미즈노 오코노미야키', description: '현지식 오코노미야키' },
  { tourPlaceId: 5, category: '명소', address: '주오구', rating: 4.7, placeName: '오사카성', description: '오사카를 대표하는 역사 명소' },
  { tourPlaceId: 6, category: '숙소', address: '신사이바시', rating: 4.3, placeName: '호텔 닛코 오사카', description: '도심 이동이 편한 숙소' },
  { tourPlaceId: 7, category: '카페', address: '난바', rating: 4.5, placeName: '리로 커피 로스터스', description: '여행 중 쉬어가기 좋은 카페' },
  { tourPlaceId: 8, category: '액티비티', address: '고노하나구', rating: 4.8, placeName: '유니버설 스튜디오 재팬', description: '하루 종일 즐기는 테마파크' },
  { tourPlaceId: 9, category: '쇼핑', address: '난바', rating: 4.4, placeName: '난바 파크스', description: '쇼핑과 식사를 함께 즐기는 공간' },
]
