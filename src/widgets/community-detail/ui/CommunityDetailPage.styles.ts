...
export const Article = styled.article`
  ...
  > h1 { margin: 12px 0 18px; color: var(--pt-text-strong); font-size: clamp(25px, 3vw, 36px); line-height: 1.3; }
  > p { margin: 0; color: var(--pt-text-muted); font-size: 17px; line-height: 1.8; white-space: pre-line; }
...
export const OwnerActions = styled.div`
  ...
  display: flex;
  gap: 8px;
  button { border: 0; background: transparent; color: var(--pt-text-muted); cursor: pointer; }
  button:last-child { color: var(--pt-status-error); }
`
...
export const ReactionRow = styled.div`
  ...
  button.active { color: var(--pt-status-error); font-weight: 700; }
`
...
export const CommentForm = styled.form`
  ...
  input { min-width: 0; height: 40px; flex: 1; border: 1px solid var(--pt-border-default); border-radius: 10px; padding: 0 12px; }
  button { width: 64px; border: 0; border-radius: 10px; background: var(--pt-brand-primary); color: var(--pt-text-inverse); cursor: pointer; font-weight: 700; }
...
export const Comment = styled.article`
  ...
  span { color: var(--pt-text-muted); font-size: 11px; }
  p { margin: 8px 0 0; color: var(--pt-text-muted); font-size: 14px; line-height: 1.55; }
`
...
export const CommentEdit = styled.div`
  ...
  gap: 6px;
  margin-top: 8px;
  input { min-width: 0; flex: 1; border: 1px solid var(--pt-border-default); border-radius: 8px; padding: 8px; }
...
export const CommentActions = styled.div`
  ...
  gap: 8px !important;
  margin-top: 6px;
  button { border: 0; padding: 0; background: transparent; color: var(--pt-text-muted); cursor: pointer; font-size: 12px; }
  button:last-child { color: var(--pt-status-error); }
`

export const EmptyComment = styled.p`margin: 0; color: var(--pt-text-muted); font-size: 14px;`
...
export const StateCard = styled.div`
  ...
  button { margin-top: 12px; border: 0; border-radius: 10px; padding: 12px 18px; background: var(--pt-brand-primary); color: var(--pt-text-inverse); cursor: pointer; }
`
