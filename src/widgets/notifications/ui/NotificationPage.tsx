  ...
  return (
    <AppShell>
      <S.Page>
        ...
        {mode === 'detail' ? <S.Detail><S.StatusDot /><h2>알림 상세 화면</h2><p>알림 API 계약이 없어 실제 알림 내용과 읽음 처리를 아직 조회할 수 없습니다.</p><S.ActionRow><PartTripButton type="button" disabled>읽음 처리</PartTripButton><PartTripButton type="button" $variant="secondary" onClick={() => navigate({ to: paths.notifications })}>목록으로</PartTripButton></S.ActionRow></S.Detail> : null}
