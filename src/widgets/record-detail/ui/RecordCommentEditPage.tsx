...
export function RecordCommentEditPage() {
  ...
  return (
    <AppShell>
      <S.Content>
        <S.TopBar><div><h1>코멘트 수정</h1><p>기존 코멘트를 수정하면 수정 이력이 함께 기록됩니다.</p></div><div><button type="button" onClick={() => navigate({ params: { recordId }, to: '/record/$recordId' })}>완료</button></div></S.TopBar>
