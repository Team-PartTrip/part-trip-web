...
export function useSignUpFlow(redirect?: string) {
  ...
  return {
    ...
    isUserIdAvailable,
    message,
    onCheckId: () => { void handleCheckId() },
    onIdChange: handleIdChange,
    onSendCode: () => { void handleSendVerificationCode() },
    onSubmit: credentialsForm.handleSubmit(handleCredentialsSubmit, handleCredentialsInvalid),
