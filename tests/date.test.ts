...
import { formatCalendarDate, formatDate, formatDateRange, formatTravelDateTime, formatTripDuration, getMonthCalendarDays, getDateRangeDays, getDateRangeWithPadding, isInCurrentCalendarWeek } from '../src/shared/utils/date.ts'
...
test('날짜 포맷과 양끝 포함 기간을 공통 규칙으로 계산한다', () => {
  ...
  assert.equal(formatTripDuration('2026-07-01', '2026-07-03'), '2박 3일')
  assert.equal(formatTripDuration('잘못된 날짜', '2026-07-03'), '')
